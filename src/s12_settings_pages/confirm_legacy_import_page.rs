...
use crate::s11_container::signal::{SaveDataSignal, Signal};
...
fn confirm_legacy_import_button<'a>(
    ...
    panel_button(
        ...
        Signal::SaveDataSignal(SaveDataSignal::ConfirmLegacyImport),
        true,
    )
}
...
fn cancel_legacy_import_button<'a>(
    ...
    panel_button(
        ...
        Signal::SaveDataSignal(SaveDataSignal::CancelLegacyImport),
        true,
    )
}